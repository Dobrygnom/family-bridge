...
console.log(JSON.stringify({ navigation, onboarding: true, compactTopicRows: compactRows.length, contextScreen: true, project: "Улучшаем Форму", chat: "Задать вопросы после расставания" }));
socket.close();
