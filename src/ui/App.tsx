...
export function App() {
  ...
  const navigationText = {
    ru: { start: "Первый запуск", connection: "Подключение", context: "Исходный чат и темы", people: "Что знает мой агент", reports: "Разговоры", settings: "Настройки", setupTitle: "Подготовка к первому разговору", connectionTitle: "Подключение и темы", contextTitle: "Исходный чат и темы", peopleTitle: "Что знает мой агент", reportsTitle: "Разговоры", settingsTitle: "Настройки" },
