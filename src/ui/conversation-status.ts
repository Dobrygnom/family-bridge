...
export const activityLabels: Record<Language, Record<NonNullable<LiveConversation["activity"]>, string>> = {
  ru: { preparing: "Помощник готовит ответ", sending: "Отправляем реплику", "waiting-peer": "Ждём ответ собеседника", "needs-answer": "Нужен ваш ответ", retrying: "Сейчас нет связи · повторим автоматически", error: "Не удалось подготовить ответ", interrupted: "Разговор приостановлен" },
...
export const repairLabels = {
  ru: { peer: "Начнём, когда приложение собеседника будет на связи", version: "Начнём после обновления второго приложения", active: "Начнём после завершения текущего разговора", queued: "Повторный разговор начнётся автоматически" },
