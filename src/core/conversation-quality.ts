...
${agentTopicRules}
Это относится и к старым сохранённым темам: suggestedOpening — подсказка, не обязательный вопрос. Если он требует вспомнить неизвестную переписку, начни с объяснения безопасного контекста и самой сути, уже обоснованной в brief или локальной перспективе. Не выдумывай глубину, если в теме есть только календарный вопрос; отсутствующий необходимый факт выясни у своего владельца через owner_question, status="paused". Исключение для этой паузы важнее требования continue ниже.
