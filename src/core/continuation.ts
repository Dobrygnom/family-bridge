...
export type MessageOrigin = "agent" | "continuation" | "owner-answer";
...
Если для поручения действительно необходим отсутствующий личный факт, исключение — status="paused" и один приватный owner_question. Не угадывай факт ради требования continue.
