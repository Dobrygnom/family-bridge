...
export class Diagnostics {
  ...
  record(event: string, fields: { version?: string; onboarding?: boolean; sourceReady?: boolean; analysisStatus?: string; people?: number; topics?: number; reports?: number; stage?: string; current?: number; total?: number; code?: string; elapsedMs?: number; topicId?: string } = {}) {
    try {
