...
export const updateIpcChannels = ["bridge:update-blocked", "bridge:notify-conversation", "bridge:get-state", "bridge:diagnose-ui", "bridge:open-diagnostics", "bridge:get-local-context-state", "bridge:add-topic", "bridge:prepare-new-topic", "bridge:send-new-topic", "bridge:block-topic", "bridge:run-conversation", "bridge:set-autostart", "bridge:set-display-name", "bridge:codex-status", "bridge:codex-login", "bridge:set-language", "bridge:set-processing-mode", "bridge:intake-start", "bridge:intake-send", "bridge:intake-finalize", "bridge:intake-reset", "bridge:list-context-threads", "bridge:select-context-thread", "bridge:sync-context", "bridge:refresh-context-now", "bridge:update-portrait-observation", "bridge:complete-onboarding", "bridge:compute-state", "bridge:compute-host", "bridge:compute-policy", "bridge:compute-request", "bridge:compute-decide", "bridge:compute-invite", "bridge:compute-join", "bridge:compute-disable", "bridge:compute-revoke", "bridge:open-reports", "bridge:create-pair", "bridge:join-pair", "bridge:update-context-topic", "bridge:refine-context-topic", "bridge:update-context-topics", "bridge:run-remote", "bridge:discuss-all-topics", "bridge:answer-owner-question", "bridge:continue-report", "bridge:approve-continuation", "bridge:retry-continuation", "bridge:request-microphone", "bridge:transcribe-audio", "bridge:cancel-dictation", "bridge:check-updates", "bridge:check-pair-versions", "bridge:install-update"] as const;
